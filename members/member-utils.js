...
function proPublicaMemberToMongo(member) {
    return {
        ...
        shortTitle: member.short_title || member.roles.short_title,
        chamber: member.chamber || member.roles.chamber,
        title: member.title || member.roles.title,
        party: member.party || member.roles.part,
        state: member.state || member.roles.state,
        crpId: member.crp_id,
